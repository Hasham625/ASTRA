...
from utils_dyn import pgd_attack
from autoattack import AutoAttack
import torch.backends.cudnn as cudnn
from torchvision.datasets import ImageFolder

import time
from utils_dyn import AverageMeter, eval_adv_test, logger, eval_test
import numpy as np
import copy
...
def cvt_state_dict(state_dict, args, num_classes):
    ...
    # zero init fc
    state_dict_new['fc.weight'] = torch.zeros(num_classes, 384).cuda()
